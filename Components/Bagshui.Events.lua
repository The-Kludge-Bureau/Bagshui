...
Bagshui:LoadComponent(
  function()
    ...
    function Bagshui:RegisterClassForEvents(classObject, eventFunctionName)
      ...
      assert(
        classObject[eventFunctionName],
        "Bagshui:RegisterClassForEvents(): "
          .. tostring(eventFunctionName)
          .. " not found on classObject "
          .. tostring(classObject)
      )
