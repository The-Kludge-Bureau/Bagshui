...
Bagshui:AddComponent(function()
  ...
  function Character:OnEvent(event, arg1)
    ...
    if event == "SPELLS_CHANGED" or event == "CHAT_MSG_SKILL" or event == "SKILL_LINES_CHANGED" then
  ...
  function Character:UpdateGear()
    ...
    for slot, localized in pairs(self.inventorySlots) do
      ...
      itemString = BsItemInfo:ParseItemLink(_G.GetInventoryItemLink("player", _G.GetInventorySlotInfo(slot)))
  ...
  function Character:PruneProfessionItems()
    if self:PruneItemList(self.professionCrafts) or self:PruneItemList(self.professionReagents) then
    ...
    return
      ...
      (
        type(characterInfo.class) == "string"
          and (_G.RAID_CLASS_COLORS[string.upper(characterInfo.class)] and _G.RAID_CLASS_COLORS[string.upper(
            characterInfo.class
          )].colorStr and ("|c" .. _G.RAID_CLASS_COLORS[string.upper(characterInfo.class)].colorStr))
        ...
        .. " "
        -- Faction color.
        .. (type(characterInfo.faction) == "string" and BS_FONT_COLOR["FACTION_" .. string.upper(characterInfo.faction)] or BS_FONT_COLOR.FACTION_UNKNOWN)
        -- Faction letter.
        .. "["
